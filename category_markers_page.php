...
<html>
	<head>
	    ...
	    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?AIzaSyAoA7iExx0zK60WO1H9tA7YhGyH3CZrQOc=API_KEY"></script>
	...
	<body>
		<div id="wrapper">
			...
			<div id="content">
				...
				<div id="centralized">
					Ακολουθούν οι αναφορές στη συγκεκριμένη κατηγορία
					<!-- ENTER SOME TEXT-->
				</div>
