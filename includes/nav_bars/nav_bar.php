      ...
      <div class="header clearfix">
         ...
         <div class="nav">
            ...
            <div>
               ...
               <ul class="menu">
                  <li><a href="home_page.php"><b>Αρχική</b></a></li>
                  ...
                  <li><a href="make_a_report_page.php">Νέα αναφορά</a></li>
                  <li><?php echo "<a href='edit_user_page.php' id='iflogged' >Χρήστης : ".$_SESSION['user_fname']."</a>"; ?></li>
                  ...
                  <li><a href="login_page.php" id="login">Σύνδεση</a></li>
                  <?php
                     }
                  ?>
