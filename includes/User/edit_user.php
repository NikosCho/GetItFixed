...
<div id="centralized">
 ...
 <!-- <h3><a href="changepass.php">[Change your password]</a></h3>-->
	<form name="myData" method="post" action="">
		...
		<span class="main_titles">Επεξεργασία στοιχείων</span> </br> </br>	
		<div class="line_height">
		
		Όνομα:</br> <input type="text" name="fname" value="<?php echo $_SESSION['user_fname']; ?>"  pattern="^[a-zA-ZαβγδεζηθικλμνξοπρστυφχψωςάέήίύόώΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ0-9 ]{2,30}$" required>	</br> 
		Eπίθετο:</br> <input type="text" name="lname" value="<?php echo $_SESSION['user_lname']; ?>"  pattern="^[a-zA-ZαβγδεζηθικλμνξοπρστυφχψωςάέήίύόώΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ0-9 ]{2,30}$" required>	</br> 
	...
	Αλλαγή κωδικού? <a href="change_password_page.php" class="a_links_css">Αλλαγή! </a>
</div>
