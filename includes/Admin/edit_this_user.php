...
<div id="centralized">
	...
	</br> <span class="main_titles">Επεξεργασία στοιχείων</span> </br> </br>	 
	<form name="myData" method="post" action="">
		

		<div class="line_height">
		Όνομα:</br> <input type="text" name="fname" value="<?php echo $usertoedit['user_fname']; ?>"  pattern="^[a-zA-ZαβγδεζηθικλμνξοπρστυφχψωςάέήίύόώΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ ]{2,30}$" required>	</br> 
		Επώνυμο:</br> <input type="text" name="lname" value="<?php echo $usertoedit['user_lname']; ?>"  pattern="^[a-zA-ZαβγδεζηθικλμνξοπρστυφχψωςάέήίύόώΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ ]{2,30}$" required>	</br> 
