...
<body>
	...
	</br> <span class="main_titles">Επεξεργασία κατηγορίας</span> </br> </br><!-- <h3><a href="changepass.php">[Change your password]</a></h3>-->
		<form name="myData" method="post" action="">
			<div class="line_height">
			Όνομα κατηγορίας :</br> <input type="text" name="cname" value="<?php echo $categorycurrentname; ?>"  pattern="^[a-zA-ZαβγδεζηθικλμνξοπρστυφχψωςάέήίύόώΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ0-9 ]{2,30}$" required>	</br> 
			</div>
			</br></br>
