...
<div id="centralized">
	...
	<form name="myData" method="post" action="">
		...
		Όνομα:</br> <input type="text" name="username" value="<?php echo $admin_user; ?>"  pattern="^[a-zA-ZαβγδεζηθικλμνξοπρστυφχψωςάέήίύόώΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ0-9 ]{2,30}$" required>	</br> 
