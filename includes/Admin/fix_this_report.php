...
<body>
	...
	</br> <span class="main_titles">Επιδιόρθωση αναφοράς</span> </br> </br><!-- <h3><a href="changepass.php">[Change your password]</a></h3>-->
		<form name="myData" method="post" action="">
			<div class="line_height">
			Αφήστε ένα σχόλιο :</br> <input type="text" name="rcomment" value="<?php echo $reporttoedit['rep_comment']; ?>"  pattern="^[a-zA-ZαβγδεζηθικλμνξοπρστυφχψωςάέήίύόώΑΒΓΔΕΖΗΘΙΚΛΜΝΞΟΠΡΣΤΥΦΧΨΩ0-9 ]{2,50}$" required>	</br> 
			</div>
			</br></br>
			<input type="submit" name="submit" value="Επιδιόρθωση"/>
